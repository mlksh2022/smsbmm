...
class SendSms():
    ...
    def KahveDunyasi(self):    
        try:    
            ...
            if len(kahve_dunyasi.json()["meta"]["messages"]["error"]) == 0:
                print(f"{Fore.LIGHTGREEN_EX}Made By MEKOlord | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> core.kahvedunyasi.com")
                self.adet += 1
            else:
                raise
        except:    
    ...
    def Bim(self):
        try:
            ...
            if bim.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By MEKOlord | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> bim.veesk.net")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By MEKOlord | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> bim.veesk.net")
    ...
    def Englishhome(self):
        try:
            ...
            if home.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}Made By MEKOlord | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> englishhome.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By MEKOlord | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> englishhome.com")
    ...
    def Icq(self):
        try:
            ...
            if r.json()["response"]["statusCode"] == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By MEKOlord | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> u.icq.net")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By MEKOlord | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> u.icq.net")
    ...
    def Evidea(self):
        try:
            ...
            if r.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}Made By MEKOlord | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> evidea.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By MEKOlord | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> evidea.com") 
    ...
    def Marti(self):
        try:
            ...
            if r.json()["isSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By MEKOlord | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> customer.martiscooter.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By MEKOlord | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> customer.martiscooter.com")
    ...
    def Hey(self):
        try:
            ...
            r = requests.post(url, headers=headers)
            if r.json()["IsSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By MEKOlord | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> heyapi.heymobility.tech")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By MEKOlord | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> heyapi.heymobility.tech")
    ...
    def Bineq(self):
        try:
            ...
            if r.json()["IsSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By MEKOlord | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> bineqapi.heymobility.tech")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By MEKOlord | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> bineqapi.heymobility.tech")
    ...
    def Tasimacim(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By MEKOlord | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> server.tasimacim.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By MEKOlord | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> server.tasimacim.com")
    ...
    def Yuffi(self):
        try:
            ...
            r = requests.post(url, json=json)
            if r.json()["success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By MEKOlord | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> api.yuffi.co")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By MEKOlord | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> api.yuffi.co")
